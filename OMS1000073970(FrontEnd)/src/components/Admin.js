                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav me-auto d-flex flex-row mt-3 mt-lg-0">
                            <li class="nav-item text-center mx-2 mx-lg-1">
                                <a class="nav-link " aria-current="page" href={`/adminItemList/${custId}`}>
                                    <div>
                            ...
                            <li class="nav-item text-center mx-2 mx-lg-1">
                                <a class="nav-link " aria-current="page" href={`/adminOrderList/${custId}`} >
                                    <div>
                                        <i class="fas fa-home fa-lg mb-1"></i>
                                    </div>
                                    Orders
                            ...
                            <li class="nav-item text-center mx-2 mx-lg-1">
                                <a class="nav-link " aria-current="page" href={`/customerList/${custId}`} >
                                    <div>
                                        <i class="fas fa-home fa-lg mb-1"></i>
                                    </div>
                                    Customers
                            ...
                            <li class="nav-item text-center mx-2 mx-lg-1">
                                <a class="nav-link " aria-current="page" href={`/addItem/${custId}`} >
                                    <div>
                                        <i class="fas fa-home fa-lg mb-1"></i>
                                    </div>
                                   AddItem
                            ...
                            <li class="nav-item text-center mx-2 mx-lg-1" >
                                <a class="nav-link " aria-current="page" style={{ marginLeft: "400px" }} href={`/adminDetails/${custId}`}>
                                    {customer.custName}
